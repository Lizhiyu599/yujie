/**
 * 玉界 - 日记软件
 * 包含：日记本 UI 渲染、翻页动画、写日记、日记设置、数据持久化
 */
    ...
    overlay.innerHTML = `
        <div class="diary-settings-panel">
            ...
            <div class="diary-font-body" id="diaryFontBody">
                <div style="font-size:11px; color:#b8a080; margin-bottom:6px;">提示：此字体仅用来表示角色的日记字体，不填写则默认字体。</div>
                ...
                <!-- 字体颜色 -->
                <div style="font-size:13px; color:#8b7355; margin:10px 0 6px;">字体颜色</div>
                <div class="diary-color-row">
                    <div class="diary-color-dot" style="background:#fff;" onclick="previewDiaryFontColor('#3c2415')"></div>
                    <div class="diary-color-dot" style="background:#000;" onclick="previewDiaryFontColor('#000')"></div>
                    <div class="diary-color-dot" style="background:purple;" onclick="previewDiaryFontColor('purple')"></div>
                    <div class="diary-color-dot" style="background:blue;" onclick="previewDiaryFontColor('blue')"></div>
                    <div class="diary-color-dot" style="background:pink;" onclick="previewDiaryFontColor('pink')"></div>
                    <input type="color" class="diary-color-picker" onchange="previewDiaryFontColor(this.value)">
                </div>
                
                <!-- 字体上传 -->
                <div style="font-size:13px; color:#8b7355; margin:10px 0 6px;">字体上传</div>
                ...
                <div style="font-size:13px; color:#8b7355; margin:8px 0 6px;">URL字体</div>
                <input type="text" class="diary-url-input" id="diaryFontUrl" placeholder="https://.../font.ttf" value="${fontSettings.fontUrl || ''}">
                <div style="font-size:10px; color:#b8a080; margin-bottom:10px;">支持 .ttf / .otf / .woff / .woff2 用于日记字体。</div>
