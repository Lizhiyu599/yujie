...
function renderListenTogetherUI() {
    ...
    appWindow.innerHTML = ''
+ '<div class="music-app" style="display:flex;flex-direction:column;height:100%;">'
+ '<div class="music-player-header" style="padding-top:48px;flex-shrink:0;">'
...
+ '</div>'
+ '<div class="lt-top-row" style="padding:8px 0;flex-shrink:0;">'
...
function changeVinylImage() {
    ...
    overlay.innerHTML = ''
        ...
        + (currentVinyl ? '<div style="width:80px;height:80px;border-radius:50%;background-image:url(' + currentVinyl + ');background-size:cover;background-position:center;position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);"></div>' : '<div style="width:80px;height:80px;border-radius:50%;background:rgba(0,0,0,0.04);position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);display:flex;align-items:center;justify-content:center;font-size:11px;color:rgba(0,0,0,0.2);">自定义</div>') 
        + '</div>'
