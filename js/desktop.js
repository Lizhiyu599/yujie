...
window.addEventListener('DOMContentLoaded', function() {
    ...
    addDesktopIcon({ id: 'music', name: '网易云音乐', icon: '<img src="https://i.ibb.co/S7mxg9tF/1782660880083.png" style="width:32px;height:32px;border-radius:9px;object-fit:cover;">', action: 'openMusic' });
