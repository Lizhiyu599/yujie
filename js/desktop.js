...
addDesktopIcon({ id: 'gallery', name: '图库', icon: '<svg width="28" height="28" viewBox="0 0 100 100" fill="none" stroke="#555" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"><rect x="18" y="30" width="64" height="48" rx="8"/><circle cx="50" cy="48" r="12"/><circle cx="50" cy="48" r="4"/><path d="M36 30 L30 18 L70 18 L64 30"/></svg>', action: 'openGallery' });
