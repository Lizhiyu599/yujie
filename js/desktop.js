...
window.addEventListener('DOMContentLoaded', function() {
    ...
    addDesktopIcon({ id: 'accounting', name: '记账', icon: '<img src="https://i.ibb.co/FbMqTMNr/1783095194517.png" style="width:32px;height:32px;border-radius:8px;object-fit:cover;">', action: 'openAccounting' });
    addDesktopIcon({ id: 'cardpack', name: '卡包', icon: '<img src="https://i.ibb.co/Pv2zqg00/1782715064654.png" style="width:32px;height:32px;border-radius:8px;object-fit:cover;">', action: 'openCardpack' });
