...
window.addEventListener('DOMContentLoaded', () => {
    ...
    // 注册聊天图标到桌面第一页
addDesktopIcon({ id: 'chat', name: '聊天', icon: '<img src="https://i.ibb.co/8ndgNszZ/retouch-2026062812062406.png" style="width:28px;height:28px;border-radius:8px;object-fit:cover;">', action: 'openChat' });
