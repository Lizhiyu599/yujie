...
window.addEventListener('DOMContentLoaded', function() {
    ...
    addDesktopIcon({ id: 'paper', name: '纸语', icon: '<img src="https://i.ibb.co/LXRSVNVd/1784178114743.png" style="width:28px;height:28px;border-radius:8px;object-fit:cover;">', action: 'openPaper', page: 1 });
